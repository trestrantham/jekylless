...
Gem::Specification.new do |s|
  ...
  s.authors = ["Tom Preston-Werner", "Tate Johnson", "Wolfgang K\303\266nig"]
  s.date = %q{2010-02-16}
  s.default_executable = %q{jekyll}
  s.description = %q{Jekyll + LESS, Growl notifications and other enhancements.}
  s.email = %q{jekylless@tatey.com}
  ...
  s.files = [
    ".gitignore",
     ...
     "test/source/_posts/2010-01-09-datetime-override.textile",
     "test/source/_posts/2010-02-15-time-override.textile",
  ...
  s.homepage = %q{http://github.com/tatey/jekylless}
